...
public class Truck extends Vehicle {
    ...
    private static final double INCREASEMENT_OF_FUEL_CONSUMPTION = 1.6;
    private static final double FUEL_LOSSES_COEFFICIENT = 0.95;
    ...
    public void refuel(double fuelAmount) {
        this.setFuelQuantity(this.getFuelQuantity() + (fuelAmount * FUEL_LOSSES_COEFFICIENT));
    }
